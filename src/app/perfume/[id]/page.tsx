        ...
        <div className="lg:w-[40%] px-6 py-12 lg:p-16 flex flex-col h-full lg:overflow-y-auto lg:h-screen sticky top-0">
          ...
          <div className="mt-auto pt-8 border-t border-ds-greige/30">
            ...
            <div className="flex gap-4">
              <Button variant="secondary" className="flex-1" disabled={perfume.status === "OUT_OF_STOCK"}>
                5ml
              </Button>
              <Button variant="primary" className="flex-1" disabled={perfume.status === "OUT_OF_STOCK"}>
                10ml
              </Button>
            </div>
          </div>
